...
fn set_active_device(
    ...
    runtime.set_active_device(device_id).map_err(to_error_string)
}
...
fn toggle_sync(
    ...
    runtime.toggle_sync(enabled).map_err(to_error_string)
}
...
fn update_settings(
    ...
    runtime.update_settings(patch).map_err(to_error_string)
}
